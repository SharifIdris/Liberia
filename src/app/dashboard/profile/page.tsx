          ...
          <form className="space-y-6">
            <div className="flex items-center gap-6">
              <Avatar className="w-24 h-24">
                <AvatarImage src="https://images.unsplash.com/photo-1506919258185-6078bba55d2a?q=80&w=150&h=150&fit=crop&crop=faces" alt="Jane Doe" data-ai-hint="student woman" />
